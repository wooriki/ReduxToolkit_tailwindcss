  ...
  return (
    <>
      <div className="bg-black p-4 w-full flex justify-center items-center">
        <p className="text-white font-inter text-2xl font-bold">Welcome All</p>
      </div>
      ...
      <div className="bg-black p-4 w-full flex items-center justify-center mx-auto">
        <div className="text-white font-inter text-base font-medium">
          50& OFF
        </div>
        <div className="text-white font-inter text-base font-medium mx-96">
